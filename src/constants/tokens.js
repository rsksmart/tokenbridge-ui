...
const DOC_TOKEN = {
  ...
  4: { symbol: 'eDOC', address: '0x09a8f2041Be23e8eC3c72790C9A92089BC70FbCa', decimals: 18 },
}
...
const DAI_TOKEN = {
  ...
  4: { symbol: 'DAI', address: '0x4F96Fe3b7A6Cf9725f59d353F723c1bDb64CA6Aa', decimals: 18 },
}
...
const SAI_TOKEN = {
  ...
  4: { symbol: 'SAI', address: '0xc7cc3413f169a027dccfeffe5208ca4f38ef0c40', decimals: 18 },
}
...
const BITPRO_TOKEN = {
  ...
  4: { symbol: 'eBITPRO', address: '0xB3c9ec8833bfA0d382a183EcED27aBc079520928', decimals: 18 },
}
...
const RIF_TOKEN = {
  ...
  4: { symbol: 'etRIF', address: '0x69f6d4d4813f8e2e618dae7572e04b6d5329e207', decimals: 18 },
}
...
const TUSD_TOKEN = {
  ...
  4: { symbol: 'TUSD', address: '0x0000000000085d4780B73119b644AE5ecd22b376', decimals: 18 },
}
...
const ZRX_TOKEN = {
  ...
  4: { symbol: 'ZRX', address: '0x2002d3812f58e35f0ea1ffbf80a75a38c32175fa', decimals: 18 },
}
...
const LINK_TOKEN = {
  ...
  4: { symbol: 'LINK', address: '0xa36085F69e2889c224210F603D836748e7dC0088', decimals: 18 },
}
...
const USDT_TOKEN = {
  ...
  4: { symbol: 'USDT', address: '0x13512979ade267ab5100878e2e0f485b568328a4', decimals: 6 },
}
...
const USDC_TOKEN = {
  ...
  4: { symbol: 'USDC', address: '0xe22da380ee6b445bb8273c81944adeb6e8450422', decimals: 6 },
}
...
const OLD_TOKEN = {
  ...
  4: { symbol: 'Ω', address: '0x865f275121113b3fe8f91632aeaa4637e8a9f861', decimals: 18 },
}
...
const BUND_TOKEN = {
  ...
  4: { symbol: 'BUND', address: '0x8d3e855f3f55109d473735ab76f753218400fe96', decimals: 18 },
}
...
const UBI_TOKEN = {
  ...
  4: { symbol: 'UBI', address: '0xddade19b13833d1bf52c1fe1352d41a8dd9fe8c9', decimals: 18 },
}
